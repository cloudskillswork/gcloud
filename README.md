...
# 👋 Welcome to neweraofcoding Tutorials!  
...
💬 Let’s collaborate, discuss tech, or just say hi! Always happy to connect with fellow cloud explorers. Active contributor, up for tech exploration and collaborative learning.
...
Its for cloud enthusiast and developers passionate about emerging technology, its all about Cloud Computing and Cybersecurity, with a focus on building robust cloud solutions.
...
- DevOps/Tools: Docker, Terraform, Kubernetes
- Databases: Firestore, SQL, NoSQL

## score
To enable Check My Progress
...
- credits debit
- badge earned
- lab category (games, trivia , skill badge)
- shell file
- execution steps
...
- Updated: [https://www.cloudskillsboost.google/catalog](https://www.cloudskillsboost.google/catalog?keywords=&locale=&skill-badge%5B%5D=skill-badge&format%5B%5D=any&language%5B%5D=any)
...
## Lab 4 - Cloud Monitoring: Qwik Start - 5 Skill Badges
...
## Lab 14 - Managing Deployments Using Kubernetes Engine - 3 Skill Badges
...
## Lab 20 - Extract, Analyze, and Translate Text from Images with the Cloud ML APIs - 2 Skill Badges
...
## Lab 33 - Data Catalog: Qwik Start - 2 Skill Badges
...
## Lab 40 - Multimodality with Gemini - 2 Skill Badges
