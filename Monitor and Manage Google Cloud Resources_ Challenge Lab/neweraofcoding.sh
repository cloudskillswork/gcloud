...
echo "║                                                            ║"
echo "║   👨‍🏫 Brought to you by neweraofcoding's Cloud Tutorials     ║"
echo "║   📺 Subscribe: https://youtube.com/@neweraofcoding.5460       ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "║   ${CYAN}Subscribe to neweraofcoding's YouTube Channel      ${WHITE}     ║"
echo "║   ${CYAN}https://youtube.com/@neweraofcoding.5460             ${WHITE}     ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "${BOLD}${BLUE}https://youtube.com/@neweraofcoding.5460${RESET}"
echo ""
