...
BOX_TOP="${BLUE}╔══════════════════════════════════════════════════╗${NC}"
BOX_MID="${BLUE}║      Welcome to neweraofcoding Channel                                            ║${NC}"
BOX_BOT="${BLUE}╚══════════════════════════════════════════════════╝${NC}"
...
echo -e "${RED}${BOLD}► Subscribe to neweraofcoding's YouTube Channel:${NC}"
echo -e "${BLUE}${UNDERLINE}https://www.youtube.com/@neweraofcoding/playlists${NC}\n"
