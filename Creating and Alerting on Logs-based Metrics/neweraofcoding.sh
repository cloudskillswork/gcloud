...
echo "${RANDOM_BG_COLOR}${RANDOM_TEXT_COLOR}${BOLD}Welcome to neweraofcoding Cloud Tutorials${RESET}"
...
echo "${BOLD}${CYAN}Thank you for using neweraofcoding Cloud Tutorials${RESET}"
