...
echo "${CYAN_TEXT}${BOLD_TEXT}   WELCOME TO neweraofcoding CLOUD ANALYTICS   ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}===============================================${RESET_FORMAT}"
echo
echo "${WHITE_TEXT}${BOLD_TEXT}📺 YouTube Channel: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
