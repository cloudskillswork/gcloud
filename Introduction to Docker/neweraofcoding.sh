...
echo "${CYAN_TEXT}${BOLD_TEXT}       Welcome to neweraofcoding's Cloud Tutorial          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}Subscribe to my channel: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
...
gcloud artifacts repositories create my-repository \
    ...
    --location=$REGION \
    --description="Docker repository by neweraofcoding"
echo "${GREEN_TEXT}${BOLD_TEXT}╔════════════════════════════════════════════════════════╗${RESET_FORMAT}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to my channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
