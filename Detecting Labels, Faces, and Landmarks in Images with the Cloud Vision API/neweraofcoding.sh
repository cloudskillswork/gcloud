...
# ==============================================
#  Cloud Vision API
#  Created by neweraofcoding Cloud Tutorials
...
echo "${BLUE}${BOLD}║        by neweraofcoding Cloud           ║${RESET}"
echo "${BLUE}${BOLD}╚══════════════════════════════════════════╝${RESET}"
echo
...
# Updated GitHub URLs
declare -A IMAGES=(
    ["city.png"]="https://raw.githubusercontent.com/cloudskillswork/gcloud/5c7847c58b86b282a6e6598f725b6a9b1ef03e95/Detecting%20Labels%2C%20Faces%2C%20and%20Landmarks%20in%20Images%20with%20the%20Cloud%20Vision%20API/city.png"
    ["donuts.png"]="https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Detecting%20Labels%2C%20Faces%2C%20and%20Landmarks%20in%20Images%20with%20the%20Cloud%20Vision%20API/donuts.png"
    ["selfie.png"]="https://raw.githubusercontent.com/cloudskillswork/gcloud/5c7847c58b86b282a6e6598f725b6a9b1ef03e95/Detecting%20Labels%2C%20Faces%2C%20and%20Landmarks%20in%20Images%20with%20the%20Cloud%20Vision%20API/selfie.png"
)
