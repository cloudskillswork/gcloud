...
echo "${BLUE_BOLD}          🚀 Welcome to neweraofcoding's Cloud Lab Tutorial        ${RESET_FORMAT}"
echo "${BLUE_BOLD}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo -e "${PURPLE_BOLD}📷 Follow on Instagram:${RESET_FORMAT} ${PINK_BOLD}https://www.instagram.com/angular_development/${RESET_FORMAT}"
echo
