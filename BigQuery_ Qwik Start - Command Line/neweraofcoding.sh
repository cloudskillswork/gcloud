...
echo -e "${BOLD_CYAN}║                                        ║${RESET}"
echo -e "${BOLD_CYAN}║   ${BOLD_YELLOW}Welcome to neweraofcoding cloud${BOLD_GREEN} Tutorials ${BOLD_CYAN}                ║${RESET}"
echo -e "${BOLD_CYAN}║                                        ║${RESET}"
echo -e "${BOLD_CYAN}╚════════════════════════════════════════╝${RESET}"
echo ""
...
wget https://github.com/cloudskillswork/gcloud/raw/refs/heads/main/BigQuery:%20Qwik%20Start%20-%20Command%20Line/names.zip
...
echo -e "${BOLD_WHITE}${BG_BLUE}════════════════════════════════════════${RESET}"
echo ""
echo -e "${BOLD_CYAN}For more tutorials, visit: ${UNDERLINE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo ""
