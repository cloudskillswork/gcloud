...
# ==============================================
# Welcome to neweraofcoding Cloud Tutorials!
# YouTube: https://www.youtube.com/@neweraofcoding/videos
# ==============================================
...
echo "║                                                              ║"
echo "║    🌐 YouTube: https://www.youtube.com/@neweraofcoding     ║"
echo "║    ⭐ Subscribe for Daily Cloud & DevOps Content ⭐         ║"
echo "║                                                              ║"
echo "║         💻 Google Cloud Infrastructure Lab 💻              ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo "${RESET}"
echo "${MAGENTA}${BOLD}🎯 Learning Objectives:${RESET}"
echo "${MAGENTA}${BOLD}• VPC Network Creation${RESET}"
echo "${MAGENTA}${BOLD}• Cloud SQL Database Setup${RESET}"
echo "${MAGENTA}${BOLD}• Kubernetes Cluster Deployment${RESET}"
echo "${MAGENTA}${BOLD}• WordPress Application Deployment${RESET}"
echo ""
...
echo "║          ✅ Google Cloud infrastructure deployed           ║"
echo "║          ✅ WordPress application running on Kubernetes    ║"
echo "║                                                              ║"
echo "║    📺 For more tutorials, visit our YouTube channel:       ║"
echo "║    🌐 https://www.youtube.com/@neweraofcoding             ║"
echo "║    ⭐ Don't forget to like, share, and subscribe! ⭐       ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo "${RESET}"
