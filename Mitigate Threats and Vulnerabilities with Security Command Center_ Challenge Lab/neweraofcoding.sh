...
curl -LO raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Mitigate%20Threats%20and%20Vulnerabilities%20with%20Security%20Command%20Center%3A%20Challenge%20Lab/findings.jsonl
...
echo
echo -e "${RED_TEXT}${BOLD_TEXT}For more tutorials, visit neweraofcoding Cloud Tutorial:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
