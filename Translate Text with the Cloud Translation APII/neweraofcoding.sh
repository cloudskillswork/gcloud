...
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}*  ${WHITE}${BOLD}Welcome to neweraofcoding's Cloud Journey!                                  ${BG_BLUE}${BOLD}*${RESET}"
...
echo "${BG_BLUE}${BOLD}*  ${YELLOW}${BOLD}https://www.youtube.com/@neweraofcoding                         ${BG_BLUE}${BOLD}*${RESET}"
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}********************************************************************************${RESET}"
echo ""
