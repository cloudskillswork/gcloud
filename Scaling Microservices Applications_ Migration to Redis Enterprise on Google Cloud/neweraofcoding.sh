...
echo "Subscribe to the channel: https://www.youtube.com/@neweraofcoding/videos"
echo "=================================================="
echo ""
...
echo "Thank you for following neweraofcoding Cloud Tutorial!"
echo "Don't forget to subscribe: https://www.youtube.com/@neweraofcoding/videos"
echo "=================================================="
