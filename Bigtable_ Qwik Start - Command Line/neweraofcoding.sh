...
echo
echo "${RED_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding Cloud Tutorials:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding/${RESET_FORMAT}"
