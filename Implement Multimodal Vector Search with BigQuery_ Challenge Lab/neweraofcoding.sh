...
header() {
    ...
    echo "${BG_MAGENTA}${BOLD}${WHITE}  neweraofcoding's BigQuery ML Vector Search Lab  ${RESET}"
    echo "${BG_MAGENTA}${BOLD}${WHITE}================================================${RESET}"
    echo
}
...
welcome() {
    ...
    echo "${YELLOW}Subscribe to my channel: https://www.youtube.com/@neweraofcoding${RESET}"
    echo
