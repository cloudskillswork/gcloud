...
echo "${BLUE_TEXT}${BOLD_TEXT}           WELCOME TO neweraofcoding TUTORIAL              ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo ""
...
echo ""
echo "${RED_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding's YouTube Channel:${RESET_FORMAT}"
