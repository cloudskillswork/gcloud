...
echo "${BG_MAGENTA}${BOLD}        WELCOME TO neweraofcoding CLOUD TUTORIAL       ${RESET}"
echo "${BG_MAGENTA}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${CYAN}${BOLD}          Expert Tutorial by neweraofcoding              ${RESET}"
echo "${YELLOW}For more GCP monitoring tutorials, visit: https://www.youtube.com/@neweraofcoding${RESET}"
echo
