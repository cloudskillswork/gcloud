...
# Display neweraofcoding's branding header
echo "${CYAN}${BOLD}================================================${RESET}"
echo "${CYAN}${BOLD}   neweraofcoding'S DATA CATALOG MIGRATION LAB   ${RESET}"
echo "${CYAN}${BOLD}================================================${RESET}"
echo "${BLUE}YouTube: https://www.youtube.com/@neweraofcoding${RESET}"
echo "${MAGENTA}Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo

# Zone selection option
if [ -z "$ZONE" ]; then
  echo "${YELLOW}${BOLD}Select your zone or press Enter to use default (us-central1-a):${RESET}"
  read -p "Zone: " ZONE
  ZONE=${ZONE:-us-central1-a}
  export ZONE
  echo "${GREEN}Using zone: $ZONE${RESET}"
else
  echo "${GREEN}Using pre-configured zone: $ZONE${RESET}"
fi
...
echo
echo "${WHITE}For more GCP and Data Catalog tutorials:${RESET}"
echo "${CYAN}YouTube: https://www.youtube.com/@neweraofcoding${RESET}"
echo "${CYAN}Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET}"
