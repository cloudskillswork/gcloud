...
clear
echo "${BG_MAGENTA}${BOLD}Welcome to neweraofcoding Cloud Tutorials${RESET}"
echo "${CYAN}Subscribe to the channel: https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo
...
echo
echo "${MAGENTA}${BOLD}Don't forget to subscribe to neweraofcoding's channel:${RESET}"
echo "${BLUE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo
