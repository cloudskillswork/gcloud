...
echo "${CYAN_TEXT}${BOLD_TEXT}       DATAPLEX SETUP TUTORIAL BY neweraofcoding            ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}For more GCP tutorials, visit: ${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
