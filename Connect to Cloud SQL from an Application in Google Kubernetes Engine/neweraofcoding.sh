...
echo "${CYAN_TEXT}${BOLD_TEXT}        WELCOME TO neweraofcoding CLOUD TUTORIAL     ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}===================================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Subscribe to the channel: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}===================================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Thank you for following neweraofcoding Cloud Tutorial!${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to the channel: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
