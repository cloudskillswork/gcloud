...
echo "${BLUE_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}💖 Don't forget to subscribe to neweraofcoding's channel! 👇${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
