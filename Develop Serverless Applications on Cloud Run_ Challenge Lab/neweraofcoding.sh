...
echo "${YELLOW_TEXT}${BOLD_TEXT}  neweraofcoding'S CLOUD DEPLOYMENT LAB  ${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo "${BLUE_TEXT}YouTube: https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo "${CYAN_TEXT}Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}neweraofcoding's YouTube Channel:${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo "${CYAN_TEXT}Video Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
