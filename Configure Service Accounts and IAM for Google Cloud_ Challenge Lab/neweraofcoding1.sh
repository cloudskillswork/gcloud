...
echo "${CYAN_TEXT}${BOLD_TEXT}🚀   neweraofcoding Cloud Tutorials - Lab  🚀${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Powered  by: neweraofcoding & Abhi${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}🚀 Creating a VM instance named 'vm-2' with e2-medium machine type...${RESET_FORMAT}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Thank you for using neweraofcoding Cloud Tutorials!${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}For more cloud tutorials and labs, visit:${RESET_FORMAT}"
echo "${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
