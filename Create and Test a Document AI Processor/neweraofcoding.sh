...
echo "${BLUE_TEXT}${BOLD_TEXT}║   WELCOME TO neweraofcoding CLOUD      ║${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}╚══════════════════════════════════════╝${RESET_FORMAT}"
echo
...
# Final message
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding Cloud Tutorial:${RESET_FORMAT} ${MAGENTA_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
