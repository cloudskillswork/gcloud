...
#----------------------------------------------------start--------------------------------------------------#
clear
echo "${BRIGHT_MAGENTA}${BOLD}🚀 Welcome to neweraofcoding cloud tutorial${RESET}"
echo "${BRIGHT_CYAN}${BOLD}🔔 Don't forget to SUBSCRIBE to neweraofcoding Cloud!${RESET}"
echo "${BRIGHT_YELLOW}${BOLD}📺 YouTube: https://www.youtube.com/@neweraofcodingCloud${RESET}"
echo ""
...
echo ""
echo "${BRIGHT_MAGENTA}${BOLD}👍 Don't forget to LIKE, SHARE, and SUBSCRIBE to neweraofcoding Cloud!${RESET}"
echo "${BRIGHT_CYAN}${BOLD}📺 YouTube: https://www.youtube.com/@neweraofcodingCloud${RESET}"
