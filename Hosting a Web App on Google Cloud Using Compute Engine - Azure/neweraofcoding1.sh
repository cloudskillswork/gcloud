...
echo "${CYAN_TEXT}${BOLD_TEXT}       neweraofcoding'S MICROSERVICES OPTIMIZATION LAB P2     ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to neweraofcoding's YouTube Channel${RESET_FORMAT}"
