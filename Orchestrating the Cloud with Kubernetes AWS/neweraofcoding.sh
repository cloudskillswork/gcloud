...
echo -e "${NC}"
echo -e "${YELLOW}🚀 Kubernetes Masterclass with neweraofcoding${NC}"
echo -e "${BLUE}------------------------------------------------${NC}"
echo -e "${CYAN}💡 Pro Tip: Follow along at https://youtube.com/@neweraofcoding.5460${NC}"
echo -e "${GREEN}🔔 Don't forget to LIKE, SHARE, and SUBSCRIBE!${NC}"
echo ""

# Concept Explanation Function
explain() {
    echo -e "\n${PURPLE}🧠 neweraofcoding Explains:${NC} $1${NC}"
}
...
echo -e "${NC}"
echo -e "${GREEN}🎉 Congratulations! You've completed neweraofcoding's Kubernetes Lab!${NC}"
...
echo -e "${BLUE}📺 YouTube: https://youtube.com/@neweraofcoding.5460${NC}"
echo -e "${BLUE}📚 Blog: https://medium.com/@eraoftech${NC}"
