...
section_header() {
    ...
    echo "${CYAN_TEXT}${BOLD_TEXT}  Welcome To neweraofcoding Cloud Tutorials Do like the video $1${RESET_FORMAT}"
    echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
    echo
}
...
echo "${MAGENTA_TEXT}${BOLD_TEXT}Network configuration  by neweraofcoding${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}All network configurations have been successfully applied by neweraofcoding's Guide.${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}For more tutorials by neweraofcoding:${RESET_FORMAT}"
