...
# Header with neweraofcoding branding
clear
echo -e "${BOX_TOP}"
echo -e "${CYAN}║   🚀 neweraofcoding's Pub/Sub Automation Lab   ║${RESET}"
echo -e "${BOX_BOT}"
echo
echo -e "${WHITE}📺 YouTube: ${BLUE}https://youtube.com/@neweraofcoding.5460${RESET}"
...
run_form_3() {
    ...
    gcloud pubsub topics publish gcloud-pubsub-topic --message="Hello from neweraofcoding's Lab"
...
echo -e "╚════════════════════════════════════════════╝${RESET}"
echo -e "${WHITE}Thank you for using neweraofcoding's Cloud Lab!${RESET}"
echo -e "${CYAN}For more tutorials, subscribe: ${BLUE}https://youtube.com/@neweraofcoding.5460${RESET}"
