...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║                                                            ║"
echo "║   🏥 Welcome To neweraofcoding Cloud Tutorial    ║"
echo "║                                                            ║"
echo "║   📺 Learn more at:                                        ║"
echo "║   ${BLINK}https://youtube.com/@neweraofcoding.5460${RESET}${BG_BLUE}${WHITE}${BOLD}               ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "║   ${BLINK}${WHITE}Subscribe to neweraofcoding's YouTube Channel${RESET}${BG_GREEN}${BLACK}${BOLD}  ║"
echo "║   ${WHITE}https://youtube.com/@neweraofcoding.5460${BLACK}                ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
