...
echo "${BLUE_BOLD}          🚀 Welcome to neweraofcoding's Cloud Tutorial     ${RESET_FORMAT}"
echo "${BLUE_BOLD}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo -e "${ORANGE_BOLD}📷 Follow on Instagram:${RESET_FORMAT} ${PURPLE_BOLD}https://www.instagram.com/angular_development/${RESET_FORMAT}"
echo
