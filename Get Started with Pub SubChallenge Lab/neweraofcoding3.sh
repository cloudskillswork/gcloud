...
echo "${CYAN_TEXT}${BOLD_TEXT}║    🚀 WELCOME TO neweraofcoding'S CLOUD LAB 🚀  ║${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${WHITE_TEXT}📺 YouTube: ${BLUE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
...
export LOCATION
export MSG_BODY='Hello from neweraofcoding Tutorials!'
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${WHITE_TEXT}${BOLD_TEXT}Thank you for using neweraofcoding's Cloud Tutorial!${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}Don't forget to subscribe: ${BLUE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
