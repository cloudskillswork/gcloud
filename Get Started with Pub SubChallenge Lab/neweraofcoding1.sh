...
echo "${CYAN_TEXT}${BOLD_TEXT}     🚀 Welcome to neweraofcoding Cloud Tutorials – GCP Lab      ${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}==============================================================${RESET_FORMAT}"
echo
...
echo -e "${WHITE_TEXT}${BOLD_TEXT}📺 Follow neweraofcoding for more Cloud Labs:${RESET_FORMAT} ${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
