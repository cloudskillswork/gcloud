...
echo "${BLUE_TEXT}${BOLD_TEXT}      WELCOME TO neweraofcoding CLOUD TUTORIAL       ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Tutorial by neweraofcoding${RESET_FORMAT}"
echo "${CYAN_TEXT}For more GCP tutorials, visit: ${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo ""
echo "${RED_TEXT}${BOLD_TEXT}Special thanks to neweraofcoding for this tutorial!${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding's YouTube channel for more GCP content:${RESET_FORMAT}"
echo "${BLUE_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
