...
echo "${BLUE}${BOLD}║                                            ║${RESET}"
echo "${BLUE}${BOLD}║    ${WHITE}${BG_BLUE} WELCOME TO neweraofcoding CLOUD TUTORIAL ${RESET}${BLUE}${BOLD}    ║${RESET}"
echo "${BLUE}${BOLD}║                                            ║${RESET}"
echo "${BLUE}${BOLD}╚════════════════════════════════════════════╝${RESET}"
echo
...
echo "${YELLOW}${BOLD}👉 Subscribe to neweraofcoding Cloud Tutorials:${RESET}"
