...
echo "${CYAN}${BOLD}   neweraofcoding'S SERVICE DIRECTORY LAB     ${RESET}"
echo "${CYAN}${BOLD}============================================${RESET}"
...
echo "${BLUE}Subscribe to neweraofcoding's YouTube Channel:${RESET}"
echo "${WHITE}https://www.youtube.com/@neweraofcoding${RESET}"
echo "${BLUE}Video Tutorials:${RESET}"
echo "${WHITE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
