...
# neweraofcoding YouTube promotion
echo -e "${YELLOW}📺 Welcome to Advanced Kubernetes Lab!${NC}"
echo -e "${MAGENTA}🌟 Don't forget to subscribe to:${NC}"
echo -e "${CYAN}   neweraofcoding YouTube Channel:${NC} ${WHITE}https://www.youtube.com/@neweraofcoding/videos${NC}"
...
echo -e "${CYAN}📚 Learn more from neweraofcoding's YouTube channel:${NC}"
echo -e "${WHITE}   https://www.youtube.com/@neweraofcoding/videos${NC}"
