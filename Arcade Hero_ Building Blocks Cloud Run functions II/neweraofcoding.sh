ro: Building Blocks Cloud Run functions II/neweraofcoding.sh
+128
...
echo -e "${BOLD}${GREEN}Welcome to neweraofcoding Cloud Tutorials!${RESET}"
echo -e "${BOLD}${CYAN}Subscribe to the channel:${RESET} https://www.youtube.com/@neweraofcoding/videos"
echo -e "${BOLD}${CYAN}==============================================${RESET}"
