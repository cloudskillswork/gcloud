...
# Welcome message
echo -e "${YELLOW}=============================================${NC}"
echo -e "${GREEN} Welcome to neweraofcoding Cloud Tutorials! ${NC}"
echo -e "${YELLOW}=============================================${NC}"
echo -e "${CYAN}Don't forget to subscribe to our YouTube channel:${NC}"
echo -e "${BLUE}https://www.youtube.com/@neweraofcoding/videos${NC}"
echo -e "${YELLOW}=============================================${NC}"
echo -e "\n"
...
echo -e "${CYAN}Thanks for following neweraofcoding Cloud Tutorials!${NC}"
