...
echo "${BLUE}${BOLD}   neweraofcoding'S CLOUD STORAGE LAB        ${RESET}"
echo "${BLUE}${BOLD}============================================${RESET}"
echo "${CYAN}YouTube Channel: https://www.youtube.com/@neweraofcoding${RESET}"
echo "${MAGENTA}Video Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo
...
IMAGE_URL="https://raw.githubusercontent.com/cloudskillswork/gcloud/main/APIs%20Explorer%20Qwik%20Start/demo-image.jpg"
...
echo "${MAGENTA}Subscribe to neweraofcoding's YouTube Channel:${RESET}"
echo "${BLUE}${UNDERLINE}https://www.youtube.com/@neweraofcoding${RESET}"
echo "${MAGENTA}Video Tutorials:${RESET}"
echo "${BLUE}${UNDERLINE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
