...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║                                                            ║"
echo "║   🏷️  Welcome to neweraofcoding Channel         ║"
echo "║                                                            ║"
echo "║   📺 Learn more at:                                        ║"
echo "║   ${BLINK}https://youtube.com/@neweraofcoding.5460${RESET}${BG_MAGENTA}${WHITE}${BOLD}             ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "${BLINK}${CYAN}https://youtube.com/@neweraofcoding.5460${RESET}"
echo ""
