...
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Cloud Tutorial by neweraofcoding${RESET_FORMAT}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}DO like share & subscribe neweraofcoding for this tutorial!${RESET_FORMAT}"
