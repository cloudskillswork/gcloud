...
echo "${BLUE_TEXT}${BOLD_TEXT}    Welcome to   neweraofcoding Cloud Tutorials     ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}https://www.youtube.com/@neweraofcodingCloudTutorials${RESET_FORMAT}"
echo
