...
echo "Subscribe to neweraofcoding Channel" > sample.txt
...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Check out our Channel: https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
