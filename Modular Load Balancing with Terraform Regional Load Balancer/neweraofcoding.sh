...
echo -e "${BLUE}${BOLD}"
echo "╔════════════════════════════════════════════╗"
echo "║   🚀 neweraofcoding's Terraform LB Deployer  ║"
echo "╚════════════════════════════════════════════╝"
echo -e "${NC}"
echo -e "${YELLOW}📺 YouTube: https://youtube.com/@neweraofcoding.5460${NC}"
...
echo "╚════════════════════════════════════════════╝"
echo -e "${NC}"
echo -e "${YELLOW}Thank you for using neweraofcoding's Terraform script!${NC}"
echo -e "${YELLOW}Don't forget to subscribe to my YouTube channel for more tutorials!${NC}"
echo -e "${BLUE}https://youtube.com/@neweraofcoding.5460${NC}"
