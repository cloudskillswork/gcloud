...
echo -e "${RESET}"
echo -e "${BRIGHT_WHITE}${BOLD}Welcome to neweraofcoding's Cloud Tutorials${RESET}"
echo -e "${BRIGHT_WHITE}YouTube: ${UNDERLINE}https://www.youtube.com/@neweraofcoding${RESET}"
echo -e "${BRIGHT_CYAN}${BOLD}=========================================${RESET}"
echo -e "${BRIGHT_CYAN}${BOLD}         WELCOME TO neweraofcoding CLOUD TUTORIAL          ${RESET}"
echo -e "${BRIGHT_CYAN}${BOLD}=========================================${RESET}"
echo
...
echo -e "${BRIGHT_WHITE}For more tutorials, visit: ${UNDERLINE}https://www.youtube.com/@neweraofcoding${RESET}"
echo
