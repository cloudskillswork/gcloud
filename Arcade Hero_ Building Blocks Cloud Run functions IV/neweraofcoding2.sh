...
echo "${BLUE_TEXT}${UNDERLINE_TEXT}Subscribe to neweraofcoding's YouTube Channel${RESET_FORMAT}"
echo "${BLUE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
