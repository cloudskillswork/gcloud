...
echo "${PURPLE_TEXT}${BOLD_TEXT}    WELCOME TO neweraofcoding CLOUD TUTORIALS   ${RESET_FORMAT}"
echo "${PURPLE_TEXT}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo ""
...
echo "${LIME_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo ""
echo -e "${MAROON_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding's Channel:${RESET_FORMAT} ${NAVY_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
