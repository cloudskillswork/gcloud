...
echo "${BG_CYAN}${BLACK}${BOLD}Welcome to neweraofcoding cloud Tutorial${RESET}"
...
echo "${BG_BLUE}${WHITE}${BOLD}Welcome to neweraofcoding Cloud Tutorials!${RESET}"
echo "${CYAN}${BOLD}Check out more cloud lab walkthroughs and tutorials at:${RESET}"
echo "${YELLOW}${BOLD}https://www.youtube.com/@neweraofcoding/videos${RESET}"
