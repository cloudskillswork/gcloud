...
echo "${CYAN_TEXT}${BOLD_TEXT}🚀  WELCOME TO neweraofcoding CLOUD TUTORIALS  🚀${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}============================================${RESET_FORMAT}"
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Don't forget to subscribe to neweraofcoding's YouTube channel:${RESET_FORMAT}"
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Thank you for following neweraofcoding's Cloud Tutorials!${RESET_FORMAT}"
