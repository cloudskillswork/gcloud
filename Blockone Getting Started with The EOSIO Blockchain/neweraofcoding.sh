#!/bin/bash
# neweraofcoding's EOSIO Blockchain Deployment Script
...
clear
echo -e "${BOX_TOP}"
echo -e "${CYAN}║   🚀 neweraofcoding's EOSIO Blockchain Lab   ║${RESET}"
echo -e "${BOX_BOT}"
echo
...
echo -e "╚════════════════════════════════════════════╝${RESET}"
echo -e "${WHITE}Thank you for using neweraofcoding's Blockchain Lab!${RESET}"
