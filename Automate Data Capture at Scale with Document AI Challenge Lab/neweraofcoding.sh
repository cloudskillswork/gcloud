...
while [ "$deploy_success" = false ]; do
  if deploy_function; then
    echo "Function deployed successfully.. Welcome to neweraofcoding Cloud Tutorials"
    echo "Subscribe to neweraofcoding: https://www.youtube.com/@neweraofcoding/videos"
  deploy_success=true
  else
    echo "Deployment Retrying, please subscribe to neweraofcoding: https://www.youtube.com/@neweraofcoding/videos"
    sleep 10
  fi
done
