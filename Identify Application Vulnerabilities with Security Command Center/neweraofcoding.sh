...
echo "${BG_BLUE}${WHITE}${BOLD}             WELCOME TO neweraofcoding CLOUD TUTORIAL             ${RESET}"
echo "${BG_BLUE}${WHITE}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${CYAN}${BOLD}          Tutorial by neweraofcoding                       ${RESET}"
echo "${YELLOW}For more security tutorials, visit: https://www.youtube.com/@neweraofcoding${RESET}"
echo
