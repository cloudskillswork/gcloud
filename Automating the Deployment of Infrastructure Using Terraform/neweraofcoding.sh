...
wget -q https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/provider.tf
wget -q https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/terraform.tfstate
wget -q https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/variables.tf
wget -q https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/mynetwork.tf

# Create instance directory and download main.tf
mkdir -p instance
cd instance
wget -q https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/main.tf
cd ..
...
echo "${CYAN}${BOLD}Remember to subscribe to neweraofcoding's YouTube channel:${RESET}"
echo "${BLUE}${BOLD}https://www.youtube.com/@neweraofcoding${RESET}"
