...
welcome_message() {
    ...
    echo "╔════════════════════════════════════════════════════════════════════╗"
    echo "║                                                                    ║"
    echo "║        WELCOME TO neweraofcoding Cloud Tutorials Do Like & SUB         ║"
    echo "║                                                                    ║"
    ...
    echo
    echo "${CYAN}For more tutorials, visit: https://www.youtube.com/@neweraofcoding${RESET}"
    echo
...
wget https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/model.ipynb
wget https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/callback_model.ipynb
wget https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/updated_model.ipynb
echo

# Clean up
echo "${BLUE}${BOLD}Cleaning up...${RESET}"
rm neweraofcoding.sh
echo
...
echo "${MAGENTA}For more tutorials, subscribe to: https://www.youtube.com/@neweraofcoding${RESET}"
