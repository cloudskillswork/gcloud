...
echo "#######################################################################"
echo "#                                                                     #"
echo "#  Welcome to neweraofcoding channel!          #"
echo "#                                                                     #"
echo "#  Don't forget to subscribe to neweraofcoding's YouTube channel for    #"
...
echo "#                                                                     #"
echo "#  Don't forget to subscribe to neweraofcoding's YouTube channel:       #"
echo "#  https://www.youtube.com/@neweraofcoding/videos                    #"
echo "#                                                                     #"
