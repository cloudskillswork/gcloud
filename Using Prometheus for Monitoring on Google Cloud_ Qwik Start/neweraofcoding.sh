...
# Expertly crafted by neweraofcoding Cloud
...
echo "${BG_BLUE}${BOLD}${WHITE}==================================================${RESET}"
echo ""
echo "${CYAN}${BOLD}⚡ Expertly crafted by neweraofcoding Cloud${RESET}"
echo "${YELLOW}${BOLD}📺 YouTube: ${UNDERLINE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo ""
...
echo "${YELLOW}${BOLD}👉 ${UNDERLINE}https://www.youtube.com/@neweraofcoding/videos${RESET}"
