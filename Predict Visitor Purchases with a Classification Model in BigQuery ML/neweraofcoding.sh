...
# Welcome message
echo -e "${YELLOW}============================================${NC}"
echo -e "${GREEN} Welcome to ${RED}neweraofcoding Cloud Tutorial${NC}"
echo -e "${YELLOW}============================================${NC}"
echo -e "${BLUE}Don't forget to subscribe to neweraofcoding's YouTube channel:${NC}"
echo -e "${GREEN}https://www.youtube.com/@neweraofcoding/videos${NC}"
echo -e "${YELLOW}============================================${NC}"
echo -e "\n"
...
echo -e "${BLUE}Thanks for using neweraofcoding's Cloud Tutorial${NC}"
echo -e "${GREEN}Subscribe for more content: https://www.youtube.com/@neweraofcoding/videos${NC}"
echo -e "${YELLOW}============================================${NC}"
