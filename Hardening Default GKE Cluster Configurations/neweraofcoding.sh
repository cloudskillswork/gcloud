...
echo -e "${BOX_BOT}"
echo -e "${CYAN}📺 YouTube: ${WHITE}https://youtube.com/@neweraofcoding.5460${NC}"
...
echo -e "╚════════════════════════════════════════════╝${NC}"
echo -e "${WHITE}Thank you for using neweraofcoding's Kubernetes Lab!${NC}"
echo -e "${CYAN}For more tutorials: ${WHITE}https://youtube.com/@neweraofcoding.5460${NC}"
