...
echo "${MAGENTA_TEXT}${BOLD_TEXT}        WELCOME TO neweraofcoding CLOUD        ${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}│  ${BLUE_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/videos${NO_COLOR}${CYAN_TEXT}   │${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}└──────────────────────────────────────────────────┘${RESET_FORMAT}"
echo
