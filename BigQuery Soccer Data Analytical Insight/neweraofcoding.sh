...
echo "*  https://www.youtube.com/@neweraofcoding/videos              *"
echo "*                                                               *"
echo "*****************************************************************"
echo "${RESET}"
...
echo "${BLUE}Don't forget to subscribe to neweraofcoding Cloud Tutorials for more content:"
echo "https://www.youtube.com/@neweraofcoding/videos${RESET}"
