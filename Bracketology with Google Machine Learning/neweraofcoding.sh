...
echo "╔════════════════════════════════════════════════╗"
echo "║                                                ║"
echo "║          WELCOME TO neweraofcoding                ║"
echo "║          CLOUD TUTORIALS DO LIKE               ║"
echo "║                                                ║"
echo "╚════════════════════════════════════════════════╝"
echo -e "\e[0m"
...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding's YouTube Channel:${RESET_FORMAT}"
echo -e "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
echo
