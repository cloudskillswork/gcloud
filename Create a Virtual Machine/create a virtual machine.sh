...
echo -e "${GREEN}${BOLD} Welcome to  neweraofcoding Cloud${RESET}"
...
echo -e "${BLUE}Special thanks to neweraofcoding!${RESET}"
echo -e "${BOLD}Don't forget to Like, Share, and Subscribe https://www.youtube.com/@neweraofcoding!${RESET}"
