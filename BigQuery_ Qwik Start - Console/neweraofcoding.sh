...
echo "${CYAN_TEXT}${BOLD_TEXT}                 Welcome to neweraofcoding cloud...                   ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}          Tutorial by neweraofcoding                       ${RESET_FORMAT}"
echo "${YELLOW_TEXT}For more BigQuery tutorials, visit: https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to neweraofcoding's Channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
