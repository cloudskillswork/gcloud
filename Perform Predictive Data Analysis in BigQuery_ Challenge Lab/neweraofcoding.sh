...
function show_banner() {
    ...
    echo "${CYAN_TEXT}${BOLD_TEXT}║     WELCOME TO neweraofcoding CLOUD TUTORIALS LET'S      ║${RESET_FORMAT}"
    ...
    echo "${BLUE_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/videos${RESET_FORMAT}"
...
echo "${WHITE_TEXT}- For more tutorials, subscribe to neweraofcoding's channel:"
