...
echo "${COLOR_BLUE}${STYLE_BOLD}║  WELCOME TO neweraofcoding CLOUD TUTORIALS    ║${FORMAT_RESET}"
echo "${COLOR_BLUE}${STYLE_BOLD}╚══════════════════════════════════════════╝${FORMAT_RESET}"
echo
...
echo -e "${COLOR_BLUE}${STYLE_BOLD}https://www.youtube.com/@neweraofcoding${FORMAT_RESET}"
echo
