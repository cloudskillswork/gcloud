...
echo "${PURPLE_COLOR}${BOLD_TEXT}  WELCOME TO neweraofcoding CLOUD TUTORIALS  ${RESET_FORMAT}"
echo "${PURPLE_COLOR}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo
...
echo "${MAROON_COLOR}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
echo -e "${NAVY_COLOR}${BOLD_TEXT}Check out neweraofcoding's Channel: \e]8;;https://www.youtube.com/@neweraofcoding\e\\https://www.youtube.com/@neweraofcoding\e]8;;\e\\${RESET_FORMAT}"
echo
