...
print_header() {
    ...
    echo "${MAGENTA_TEXT}${BOLD_TEXT}    🚀 neweraofcoding Cloud Lab Setup 🚀     ${RESET_FORMAT}"
...
main() {
    ...
    echo -e "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding/${RESET_FORMAT}"
