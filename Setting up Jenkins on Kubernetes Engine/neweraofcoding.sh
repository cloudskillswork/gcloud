#!/bin/bash
# neweraofcoding's Jenkins on GKE Deployment Script
...
echo "${BOX_MID}"
echo "  🚀 neweraofcoding's Jenkins CD on GKE Setup  "
echo "${BOX_MID}"
echo "${BOX_BOT}${RESET}"
echo
echo "${WHITE}📺 YouTube: ${BLUE}https://youtube.com/@neweraofcoding.5460${RESET}"
...
echo "${BOX_BOT}${RESET}"
echo
echo "${WHITE}Thank you for using neweraofcoding's deployment script!${RESET}"
echo "${YELLOW}Don't forget to subscribe: ${BLUE}https://youtube.com/@neweraofcoding.5460${RESET}"
echo
