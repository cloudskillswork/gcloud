...
echo "${BLUE_BOLD}          🚀 Welcome to neweraofcoding's Cloud Lab         ${RESET_FORMAT}"
echo "${BLUE_BOLD}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
gcloud compute firewall-rules create allow-http \
    --allow=tcp:80 \
    --description="Subscribe to neweraofcoding" \
    --direction=INGRESS \
...
echo "${GREEN_BOLD}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${YELLOW_BOLD}📺 Subscribe to my Channel:${RESET_FORMAT} ${BLUE_BOLD}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo -e "${PURPLE_BOLD}📷 Follow on Instagram:${RESET_FORMAT} ${ORANGE_BOLD}https://www.instagram.com/angular_development/${RESET_FORMAT}"
echo
