...
echo "${BLUE_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}          Tutorial by neweraofcoding - GCP Expert        ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}   Learn more at: ${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${UNDERLINE_TEXT}${BOLD_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
