...
# Display header with neweraofcoding branding
...
curl -O https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/start_station_name.csv || {
    echo "${RED}Failed to download start_station_name.csv${RESET}"
    exit 1
}

curl -O https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/end_station_name.csv || {
