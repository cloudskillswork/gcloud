...
echo "${BG_MAGENTA}${BOLD}   neweraofcoding'S TERRAFORM MODULES LAB    ${RESET}"
echo "${BG_MAGENTA}${BOLD}============================================${RESET}"
echo "${BLUE}YouTube Channel: https://www.youtube.com/@neweraofcoding${RESET}"
echo "${CYAN}Video Tutorials: https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo
...
curl -s -O https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Interact%20with%20Terraform%20Modules/index.html || {
  echo "${YELLOW}⚠️ Failed to download index.html${RESET}"
}

curl -s -O https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Interact%20with%20Terraform%20Modules/error.html || {
...
echo "${CYAN}Subscribe to neweraofcoding's YouTube Channel:${RESET}"
echo "${YELLOW}https://www.youtube.com/@neweraofcoding${RESET}"
echo "${CYAN}Video Tutorials:${RESET}"
echo "${YELLOW}https://www.youtube.com/@neweraofcoding/videos${RESET}"
