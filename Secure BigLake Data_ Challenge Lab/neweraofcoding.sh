...
echo "${CYAN_TEXT}${BOLD_TEXT}         WELCOME TO neweraofcoding'S CHANNEL        ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}          Expert Tutorial by neweraofcoding              ${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}   Learn more at: ${UNDERLINE_TEXT}https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
