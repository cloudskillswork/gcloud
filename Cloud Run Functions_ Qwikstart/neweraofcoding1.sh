...
echo "${COLOR_CYAN}${BOLD}│         Welcome to neweraofcoding Cloud Tutorial           │${COLOR_RESET}"
echo "${COLOR_CYAN}${BOLD}└──────────────────────────────────────────────────────────────┘${COLOR_RESET}"
echo
...
# Deploy Slow Go Function (updated to Go 1.23)
echo
...
# Deploy Concurrent Function (updated to Go 1.23)
echo
...
echo "${COLOR_CYAN}${BOLD}https://www.youtube.com/@neweraofcoding/videos${COLOR_RESET}"
echo "${COLOR_MAGENTA}${BOLD}neweraofcoding - Cloud Solutions Expert${COLOR_RESET}"
echo
