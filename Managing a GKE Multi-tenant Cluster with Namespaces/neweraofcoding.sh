...
echo "${YELLOW}${BOLD}   neweraofcoding'S GKE MULTI-TENANCY LAB     ${RESET}"
echo "${YELLOW}${BOLD}============================================${RESET}"
...
echo "${BLUE}For tutorial videos, visit: https://www.youtube.com/@neweraofcoding/videos${RESET}"
echo
...
echo "${BLUE}${BOLD}Subscribe to neweraofcoding's YouTube Channel:${RESET}"
echo "${CYAN}https://www.youtube.com/@neweraofcoding${RESET}"
echo "${BLUE}${BOLD}Video Tutorials:${RESET}"
echo "${CYAN}https://www.youtube.com/@neweraofcoding/videos${RESET}"
