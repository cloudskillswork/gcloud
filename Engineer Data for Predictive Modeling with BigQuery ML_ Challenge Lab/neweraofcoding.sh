...
echo "${MAGENTA_TEXT}${BOLD_TEXT}Welcome to neweraofcoding's BigQuery ML Lab Setup${RESET_FORMAT}"
echo "${CYAN_TEXT}For more cloud ML tutorials: https://www.youtube.com/@neweraofcoding${RESET_FORMAT}"
echo
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}💖 If you found this helpful, subscribe to neweraofcoding's channel:${RESET_FORMAT}"
