...
```bash
curl -LO https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Deploy%20a%20Hugo%20Website%20with%20Cloud%20Build%20and%20Firebase%20Pipeline/neweraofcoding1.sh

source neweraofcoding1.sh
```
***Now Check the score for Task 2 & then go ahead with next Commands.***

##
```bash
curl -LO https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Deploy%20a%20Hugo%20Website%20with%20Cloud%20Build%20and%20Firebase%20Pipeline/neweraofcoding2.sh

source neweraofcoding2.sh
```
...
```bash
curl -LO https://raw.githubusercontent.com/cloudskillswork/gcloud/refs/heads/main/Deploy%20a%20Hugo%20Website%20with%20Cloud%20Build%20and%20Firebase%20Pipeline/neweraofcoding3.sh

source neweraofcoding3.sh
```
