...
echo "${BG_MAGENTA}${BOLD}Starting Execution - neweraofcoding Cloud Tutorials${RESET}"
...
curl -LO https://raw.githubusercontent.com/cloudskillswork/gcloud/main/Create%20and%20Manage%20Cloud%20Spanner%20Instances%3A%20Challenge%20Lab/Customer_List_500.csv
...
# Completion message
echo "${BG_RED}${BOLD}Lab Completed Successfully - neweraofcoding Cloud Tutorials${RESET}"
echo "${BLUE}For more tutorials visit: https://www.youtube.com/@neweraofcodingCloudTutorials${RESET}"
