...
# Welcome message
echo "${CYAN}${BOLD}"
echo "Welcome to neweraofcoding Tutorials!"
echo "Please do like, share and subscribe to our YouTube channel:"
...
echo "${BG_RED}${BOLD}Do like the video and subscribe the channel !!!${RESET}"
